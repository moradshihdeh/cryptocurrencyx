...
function transformResponsetData(res) {
    res.data = transform(res.data, res.headers, res.headers.transformResponse);
    return res;
}
...
function formVal2Start(val1, val2) {
    if (typeof val2 !== 'undefined') {
        return val2;
    }
}
function deepMergeStart(val1, val2) {
...
var startKeyFromVal2 = ['url', 'params', 'data'];
startKeyFromVal2.forEach(function (key) {
    starts[key] = formVal2Start;
});
var startKeysDeepMerge = ['header', 'auth'];
...
var Axios = /** @class */ (function () {
    ...
    Axios.prototype.request = function (url, config) {
        ...
        while (chain.length) {
            var _a = chain.shift(), resolved = _a.resolved, rejected = _a.rejected; // 类型断言
    ...
    Axios.prototype.getUrl = function (config) {
